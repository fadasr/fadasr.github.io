...
curve25519 is birationally equivalent to a twisted Edwards curve:

```
edwards25519: -x^2 + y^2 = 1 + dx^2y^2
...
[EdDSA](https://tools.ietf.org/html/rfc8032) is based on performance-optimized elliptic curves, such as the 255-bit curve [Curve25519](https://tools.ietf.org/html/rfc7748). It is a variant of Schnorr's signature system with (possibly twisted) Edwards curves. EdDSA uses small public keys (32 or 57 bytes) and signatures (64 or 114 bytes) for Ed25519 and Ed448, respectively. The 32-byte public key `Q` is generated by the following steps:
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIzMTg3NjAxOSwtMTEyNjczNDU3NSwtMT
kxNDUyODI5MSwxMjM4OTEzMzA4LC02NTcwODgwOCwtOTE0MjY3
MjY2LDg0NTQ4ODAzMCwtMTQ2OTM3MzY2NSw5ODMyMjc4MTcsOD
c1MjI3ODgsLTIxMzEzODYwNzEsLTgzOTIzNTAxNSwtMTY0MTA1
NzQ2NSwtNjE5Nzk3NTczLDIwNDI5ODI5OTUsLTM4OTgxMDUwNC
wtMTUyNzQ5ODIzMCwxNTIxOTAyNSwtMTE4NjgzNDI1NCw5OTA4
MjIyNDhdfQ==
-->