...
[EdDSA](https://tools.ietf.org/html/rfc8032) is based on performance-optimized elliptic curves, such as the 255-bit curve [Curve25519](https://tools.ietf.org/html/rfc7748). It is a variant of Schnorr's signature system with (possibly twisted) Edwards curves.

```
twisted Edwards curve -x^2 + y^2 = 1 + d*x^2*y^2 when p = 1 mod 4.

EdDSA uses small public keys (32 or 57 bytes) and signatures (64 or 114 bytes) for Ed25519 and Ed448, respectively. The 32-byte public key is generated by the following steps:
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgzMzA0NjY0OCw5ODMyMjc4MTcsODc1Mj
I3ODgsLTIxMzEzODYwNzEsLTgzOTIzNTAxNSwtMTY0MTA1NzQ2
NSwtNjE5Nzk3NTczLDIwNDI5ODI5OTUsLTM4OTgxMDUwNCwtMT
UyNzQ5ODIzMCwxNTIxOTAyNSwtMTE4NjgzNDI1NCw5OTA4MjIy
NDhdfQ==
-->