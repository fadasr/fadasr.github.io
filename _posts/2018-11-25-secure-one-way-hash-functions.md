...
- one-way function: a function that is easy to compute but hard to invert. aka pre-image-resistance function: given only the digest `h`, finding the message `m` is nontrivial
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MDE4Mzc4MDYsLTMwMjM4NjUwOSwzNz
A1OTE0OTUsMjAxOTQ3ODEzMiwtMTMzNTE0MjU0OSw2MjAyMDUy
ODJdfQ==
-->