...
```
ed = 1 (mod t) can also be expressed like this: ed = i*t + 1, where i is an integer. In other word, find ed-1 that is divisible by t.
i = 1 : is t+1 divisible by 
d = 147
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjUzMDg2NTU5LC0xMDg2NTg3MDU5LDg5Nj
